    ...
    <div className="min-h-screen bg-green-950 text-stone-100 flex items-center justify-center p-8 font-serif">
      <div className="w-full max-w-lg">
        ...
        {schermata === "intro" ? (
          // SCHERMATA INIZIALE
          <div className="text-center">
            <p className="text-yellow-200 text-xs tracking-widest uppercase mb-2">Quiz filosofico</p>
            <h1 className="text-5xl font-black mb-2">Filosofia</h1>
            <h2 className="text-5xl font-black text-orange-700 mb-8">Applicata</h2>
            <p className="text-stone-400 mb-10 text-sm">Scopri a quale grande filosofo ti avvicini di più</p>
            <button
          ...
          <>
            ...
            <div className="text-center mb-10">
              <p className="text-yellow-200 text-xs tracking-widest uppercase mb-2">Quiz filosofico</p>
              <h1 className="text-3xl font-black text-slate-100">Quale filosofo sei?</h1>
            </div>
              ...
              <div>
                ...
                <div className="mb-8">
                  <div className="flex justify-between mb-2">
                    <span className="text-xs text-slate-100">Domanda {indiceDomanda + 1} di {domande.length}</span>
                    <span className="text-xs text-slate-100">{Math.round((indiceDomanda / domande.length) * 100)}%</span>
                  </div>
                ...
                {/* Domanda */}
                <h2 className="text-xl font-bold mb-6 leading-snug">{domanda.testo}</h2>
                ...
                <div className='flex gap-2'>
                  ...
                  <button
                    onClick={indietro}
                    className="mt-2 py-4 w-full px-6 rounded-xl border border-zinc-700 text-stone-300 font-bold font-serif hover:border-zinc-500 transition-all duration-200"
                  >
                    ← Indietro
                  </button>
                ...
                ${rispostaCorrente !== undefined
                        ? "bg-orange-800 text-slate-200 cursor-pointer hover:bg-orange-900"
                        : "bg-transparent border border-zinc-700 text-slate-100 cursor-not-allowed"
                      }`}
                  >
